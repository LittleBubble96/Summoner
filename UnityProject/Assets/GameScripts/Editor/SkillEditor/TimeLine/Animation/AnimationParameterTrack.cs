...
[TrackClipType(typeof(AnimationParameterClip))]
[TrackBindingType(typeof(Animator))]
public class AnimationParameterTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<AnimationParameterMixerBehaviour>.Create(graph, inputCount);
    }
}



public class AnimationParameterMixerBehaviour : PlayableBehaviour
{
