...
[TrackClipType(typeof(WindDownParameterClip))]
public class WindDownParameterTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<WindDownParameterMixerBehaviour>.Create(graph, inputCount);
    }
}



public class WindDownParameterMixerBehaviour : PlayableBehaviour
{
